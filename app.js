...
const ADMIN_USERNAME = process.env.ADMIN_USERNAME || "Alan";
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || "AP";
// 新增第二組帳密
const ADMIN2_USERNAME = process.env.ADMIN2_USERNAME || "Peiya";
const ADMIN2_PASSWORD = process.env.ADMIN2_PASSWORD || "PP";
...
app.post("/auth/login", (req, res) => {
  ...
  // 驗證是否為任一組合法的 username/password 配對
  const validLogin =
